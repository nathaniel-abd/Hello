...
function add(title) {
    document.getElementById("content").innerHTML += "<div class='list' id='" + listNum + "'><center><p class='cardTitle'>" + title + "</p><div class='noteCont" + listNum + "'></div><button onclick='noteCookie()'>+</button></center></div>";
    listNum += 1;
}
